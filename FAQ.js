...
export default function FAQ() {
  return (
    ...
    <div class="container-fluid " style={{backgroundColor:'lightpink'}}><br></br>
      <center><span class="badge rounded-pill bg-light"><h1>FAQ</h1></span></center>
      <br></br>
...
<div class="list-group">
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>Transport Buddy is a platform where we provide those vehicles which are returing back to their initial location after completing their primary trips. Thus, you will get a discount of 20%(approx) as compared to other platforms.</a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>Once our system receives your booking, you will be notified of the approximate distance that your goods will travel, and accordingly your bill amount will be calculated after completing the journey.</a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>You will receive an auto-generated invoice on your registered e-mail ID once the consignment has been delivered.</a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>You can definitely do so. However, extra costs for the extra point of delivery or pick-up will be levied accordingly. Our team will provide you with the additional cost incurred at the time of booking.</a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>We are committed to fulfil our responsibility toward all confirmed bookings. In the event of not being able to do so due to unforeseen circumstances, you will be notified well ahead of the pick-up time.</a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>Sorry, this option is currently not available with Transport Buddy, however you can contact our customer support team and we will try to find the best option for you.</a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>Currently we are accepting bookings at the least an hour prior to your desired pick-up time. </a><br></br>
  ...
  <a href="#" class="list-group-item list-group-item-action active" style={{backgroundColor:'white', fontSize:'15px', color:'black'}}>If the truck has reached client location and there is delay in loading per day waiting charges range from 1000 to 5000 depending on vehicle type , if the vehicle is not loaded and returned empty customer is liable to pay driver fuel charges and waiting charges.</a><br></br>
</div>
