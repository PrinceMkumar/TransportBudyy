...
(props) {
  ...
  {
    const result = await axios.get('http://localhost:8080/api/user', { params: { name: localStorage.getItem('username') } });
      ...
      <ul class="navbar-nav offset-3">
        ...
        <h5><a class="nav-link dropdown-toggle mt-1" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Orders</a>
          <div class="dropdown-menu">
            <a class="dropdown-item" href="/User_Order_Pending">Pending Orders</a>
            <a class="dropdown-item" href="/User_Order_Active">Active Orders</a>
            <a class="dropdown-item" href="/User_Order_History">Order History</a>
          </div></h5>
        </li>
        <li class="nav-item">
  ...
  <div class="media">
         <img src={require('./Images/c.png')}  style={{height:'508px',width:'700px'}}/> 
    ...
    {vehicles.map(function fin(props)
    {
      return(
        <div className="col-12">
         <img src={require('./Images/u.png')} alt="Navbar" className="rounded offset-1" style={{height:'254px',width:'300px'}}/>  <br></br>  
      {/* <tr class="table-active"> */}<br></br>
