...
export default function AdminLogin(props) {
  ...
  async function handleLogout()
  {
    ...
    const Register = () => {
      ...
      const Admin_Order_Completed = () => {
        history.push("/Admin_Order_Completed")
      };
  ...
  <div class="card" >
    ...
    <div class="card-body">
    <center><button type="button" class="btn btn-outline-primary" >New Orders</button></center>
  ...
  <img class="card-img-top" src={require('./Images/p.png')} style={{height:'200px',width:'289px'}} alt="Card image cap"></img>
    <div class="card-body">
    <center><button type="button" class="btn btn-outline-primary" >Active Orders</button></center>
