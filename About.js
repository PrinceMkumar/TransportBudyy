...
export default function About() {
  return (
    ...
    <img src={require('./Images/f.PNG')}  alt="Full load Services " class="rounded mx-auto d-block" style={{height:'200px',width:'300px'}}></img>
    <br></br>
 ...
 <br></br> <br></br>
 <img src={require('./Images/g.PNG')}  alt="Quick and Easy Portal " class="rounded mx-auto d-block" style={{height:'200px',width:'300px'}}></img><br></br>  
 ...
 <br></br><center><h4>Our commitment</h4></center>
  
 
 We are a dedicated group of professionals, committed to delivering value for you.  You will get what we have promised you. We don’t make false promises and don’t hide anything from you. When we make the commitment, you will get the delivery- no excuses.
 <br></br>
  
 
 <br></br><center><h4>Our Vision</h4></center>
  
 
 To stay ahead among our rivals in the transport and logistics industry by providing world-class and innovative moving solutions to our clients. We wish to become the top choice of our customers when they are looking for a reliable, affordable and professional transporter.
 <br></br>
  
 
 <br></br><center><h4>Our Mission</h4></center>
 ...
 <br></br><br></br><center><span class="badge rounded-pill bg-light"><h5>Looking for a trustworthy and specialized transport company? Get in touch with us today!</h5></span></center>
