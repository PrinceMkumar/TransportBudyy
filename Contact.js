...
<>
    ...
    <div style={{backgroundColor:'lightgray'}}><h1><center>Get In Touch</center></h1>
    <ul class="nav nav-tabs" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link" style={{fontSize:'25px'}}data-bs-toggle="tab" href="#home" aria-selected="false" role="tab" tabindex="-1">Registered Office</a>
  </li>
</ul><br></br>
<center><p><h6>
Green Park<br></br>
...
<img src={require('./Images/e.PNG')}  alt="Map Desc" class="mx-auto d-block rounded " style={{height:'250px',width:'500px'}}/><br></br><br></br>
<center><span class="badge rounded-pill bg-light"><h5>You can call us or meet us at our office address or email us at the email address provided.</h5></span></center>
<br></br>
