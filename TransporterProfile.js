    ...
    {vehicles.map(function fin(props)
    {
      return(
        <div className="col-12">
         <img src={require('./Images/u.png')} alt="Navbar" className="rounded offset-1" style={{height:'250px',width:'300px'}}/>  <br></br><br></br>  
      <tr class="table-active"><br></br>
        {/* <h5><span className="col-4"><strong>Transporter Id :</strong></span><span>{props.userId}</span></h5><br></br> */}
        <h5><span className="col-4"><strong>Transporter Name :</strong></span><span>{props.transportername}</span></h5><br></br>
        ...
        {/* <h5><span className="col-4"><strong>Password :</strong></span><span>{props.password}</span></h5> */}
      </tr>
